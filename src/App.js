...
function App() {
  return (
    <div className="h-screen w-screen items-center justify-center content-center">
      <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 w-96 items-center justify-center">
